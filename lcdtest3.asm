...
lcd_command:
      ...
      ; input is a pointer in [0] and [1]
      ; the subroutine uses a, x
print_string:
      mov x. 0
loop_print_string:
      mov a, [zp[0] + x]  ; read the next character
      cmp a, 0   ; check if the character is zero
      br  zflag=1, exit_print_string
      call print_char ; print it
      inc x
      jump loop_print_string
exit_print_string
      ret
...
somestring:  db  65, 66, 67, 68, 0  ;  ABCD in ascii
